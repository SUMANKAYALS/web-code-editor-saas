...
export default function SnippetDetailPage() {
    ...
    const snippetId = params?.id as Id<"snippets"> | undefined;

    // Prevent Convex error by skipping query if snippetId not ready
            ...
            <main className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
                ...
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <div className="mb-8 rounded-2xl overflow-hidden border border-[#ffffff0a] bg-[#121218]">
                        ...
                        <Editor
                            height="600px"
                            language={LANGUAGE_CONFIG[snippet.language]?.monacoLanguage || "javascript"}
                            value={snippet.code}
                            theme="vs-dark"
